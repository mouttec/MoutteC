...
switch ($video['action']) {
    case 'listContractVideos':
        $result = $videoRequest->listContractVideos($video['idContract']);
        break;
    case 'searchVideo':
        $result = $videoRequest->searchVideo($video['idVideo']);
        break;
    default:
        $result = $videoRequest->listVideos();
        break;
}
