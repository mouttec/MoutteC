...
class PDF extends FPDF
{
	...
	{
		$thisDate = implode('/', array_reverse(explode('-', substr($thisDailyPayment->dateDailyPayment, 0, 10))));
	    // Logo
	    ...
	    $this->Ln(0);
	    $this->Cell(70);
	    $this->Cell(30,10,'N° : '. $thisDailyPayment->invoiceNumber,1,0,'C');
	    $this->Ln(0);
	    $this->Cell(70);
...
$thisDailyPayment = $dailyPayment->searchPaymentById($dailyPayment);
$booking->idBooking = $thisDailyPayment->idBooking;
$thisBooking = $booking->searchBookingById($booking);
$contract->idBooking = $thisDailyPayment->idBooking;
